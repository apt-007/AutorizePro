...
class MatchReplace():
    ...
    def draw(self):
        ...
        # Ensure enough rows are visible to trigger scrolling when necessary
        self._extender.MRList.setVisibleRowCount(5)

        # Initialize scrollMRList as an instance attribute
